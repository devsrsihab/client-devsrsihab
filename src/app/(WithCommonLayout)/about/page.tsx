...
export const metadata: Metadata = {
  ...
  description:
    "Learn about our company, our mission, and our team. Discover our journey and the values that drive us forward.",
  openGraph: {
    title: "About Us | Our Company",
    description:
      "Learn about our company, our mission, and our team. Discover our journey and the values that drive us forward.",
...
export default function AboutPage() {
  return (
    <>
      <div className="bg-white dark:bg-[#0e1629]">
        <main className="isolate">
          {/* Hero section */}
          <div className="relative isolate -z-10 overflow-hidden bg-gradient-to-b from-[#0284c7]/20 dark:from-[#38bdf8]/20 pt-14">
            <div
              aria-hidden="true"
              className="absolute inset-y-0 right-1/2 -z-10 -mr-96 w-[200%] origin-top-right skew-x-[-30deg] bg-white dark:bg-[#0e1629] shadow-xl shadow-[#0284c7]/10 ring-1 ring-[#0284c7]/50 dark:ring-[#38bdf8]/50 sm:-mr-80 lg:-mr-96"
            />
            <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8 bg-white dark:bg-[#0e1629]">
              <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
                <h1 className="max-w-2xl text-4xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-6xl lg:col-span-2 xl:col-auto">
                  ...
                  group of people working from around the world to build the
                  future of ecommerce.
                </h1>
            ...
            <div className="absolute inset-x-0 bottom-0 -z-10 h-24 bg-gradient-to-t from-white dark:from-[#0e1629] sm:h-32" />
          </div>
            ...
            <div className="mx-auto flex max-w-2xl flex-col items-end justify-between gap-16 lg:mx-0 lg:max-w-none lg:flex-row">
              ...
              <div className="w-full lg:max-w-xl lg:flex-auto">
                ...
                <div className="mt-8 flex border-t border-gray-100 dark:border-gray-800 pt-8">
                  <a
                    href="#"
                    className="text-sm font-semibold leading-6 bg-[#0284c7] hover:bg-[#0284c7]/90 dark:bg-black dark:hover:bg-black/90 text-white px-4 py-2 rounded-md transition-colors"
                  >

...
const Banner: React.FC = () => {
  ...
  return (
    <div
      id="introSection"
      className="relative w-full min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 text-gray-800 dark:text-white overflow-hidden"
    >
